...
public:
	TestScreen() : LVScreen(){
		...
		lv_group_add_obj(inputGroup, (message = new ConvoMessage(obj, "Lorem ipsum dolor sit amet", true, 20, false))->getLvObj());
		lv_group_add_obj(inputGroup, (new ConvoMessage(obj, "Answer", false, 20, false))->getLvObj());
